...
{
  // Google Fonts
  wp_enqueue_style('google-fonts', '//fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100..900;1,100..900&family=Noto+Serif+JP:wght@200..900&family=Zen+Kaku+Gothic+New:wght@400,500,600,700&display=swap', array(), null);
  ...
  wp_enqueue_script('luminous-script', get_theme_file_uri('/assets/luminous/luminous.min.js'), array(), null, true);
  ...
  wp_enqueue_style('luminous-style', get_theme_file_uri('/assets/luminous/luminous-basic.min.css'), array(), null, 'all');
